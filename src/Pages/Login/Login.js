      ...
      <div className="container py-5 d-md-flex justify-content-between login_container">
        ...
        <div className="sideNote2 container col-12 col-md-6 ms-md-2  mt-sm-5">
          ...
          <p>
            ...
            Forum Networks helps people find the answers they need, when they
            need them. We're known for our public Q&A platform that many people visit every day to ask questions, learn, and
